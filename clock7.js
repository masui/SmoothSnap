...
(function() {
  var bgclicked, clicked, dummyEventHandler, getMouseX, getMouseY, hour, min, mousedownbg, mousedownbg_precise, mousedownknob, mousedownx, mousedowny, mousemove, mouseup, mousex, mousey, newhour, newmin, newsec, sec, settable, settime, timetable;
  ...
  mousedownbg_precise = function(event) {
    bgclicked = true;
    mousedownx = getMouseX(event);
    mousedowny = getMouseX(event);
    mousex = mousedownx;
