...
#      puts "#{key}\t#{entry}\t#{yomi}"
      ...
      authorid = $1
      workid = $2
      # texturl = "http://www.pitecan.com/SmoothSnap/aozora/#{authorid}_#{workid}.txt"
      texturl = "http://www.pitecan.com/www.aozora.gr.jp/cards/#{authorid}/card#{workid}.html"
...
<div class="element #{divtype}" id="element#{id}" yomi="#{@yomi[entry].chop}">
  ...
  <div class=entry>　　<a href="#{url}">#{s2}</a>　<a href="#{texturl}">(テキスト)</a> </div>
</div>
EOF
